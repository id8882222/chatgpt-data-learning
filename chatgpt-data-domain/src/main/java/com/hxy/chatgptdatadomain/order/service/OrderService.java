package com.hxy.chatgptdatadomain.order.service;
...
import com.hxy.chatgptdatadomain.order.model.valobj.OrderStatusVO;
import com.hxy.chatgptdatadomain.order.model.valobj.PayStatusVO;
import com.hxy.chatgptdatadomain.order.model.valobj.PayTypeVO;
...
public class OrderService extends AbstractOrderService{
    ...
    @Override
    public boolean changeOrderPaySuccess(String orderId, String transcationId, BigDecimal totalAmount, Date payTime) {
        return orderRepository.changeOrderPaySuccess(orderId, transcationId, totalAmount, payTime);
    }
    ...
    public List<String> queryTimeoutCloseOrderList() {
        return orderRepository.queryTimeoutClosedOrderList();
    }
